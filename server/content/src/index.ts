...
export const mentalHealthTips = [
	{
		...
		description:
			'Tawakkul is the Islamic concept of placing trust and reliance on Allah. It helps reduce anxiety and stress by recognizing that ultimate control rests with Allah, and humans can only do their best.',
	},
	{
		id: 2,
		name: 'Dua (Supplication)',
		description:
			'Praying and making supplications to Allah is a powerful way to seek comfort, guidance, and relief during times of mental distress or hardship.',
	},
	{
		id: 3,
		name: 'Sabr (Patience)',
		description:
			'Sabr is the virtue of patience and perseverance in the face of adversity. It can be a source of inner strength and resilience during difficult times.',
	},
	{
		id: 4,
		name: 'Community Support',
		description:
			'Engaging with the Muslim community and seeking support from friends, family, or mental health professionals is encouraged to address mental health challenges.',
	},
	{
		id: 5,
		name: 'Gratitude (Shukr)',
		description:
			"Practicing gratitude and recognizing the blessings in one's life can improve mental well-being and foster a positive outlook.",
	},
	{
		id: 6,
		name: 'Self-Care',
		description:
			"Taking care of one's physical and emotional needs, as well as seeking a balance between worldly and spiritual obligations, is vital for mental health.",
	},
	{
		id: 7,
		name: 'Forgiveness',
		description:
			'Forgiving oneself and others can release mental burdens and promote inner peace. Islam encourages forgiveness as a path to mental healing.',
	},
	{
		id: 8,
		name: 'Seeking Knowledge',
		description:
			'Acquiring knowledge, especially related to Islamic teachings and personal development, is a means to improve mental health and well-being.',
	},
	{
		id: 9,
		name: 'Helping Others',
		description:
			'Assisting those in need and engaging in acts of kindness and charity can bring a sense of purpose and fulfillment, positively impacting mental health.',
	},
	{
		id: 10,
		name: 'Awareness and Destigmatization',
		description:
			'Raising awareness about mental health issues within the Muslim community and destigmatizing seeking professional help is essential for addressing mental health challenges.',
	},
];
...
export const courses = [
	{
		...
		name: 'Seeking Knowledge',
		description:
			'In Islam, seeking knowledge is highly encouraged. Taking a course is a means of acquiring knowledge and fulfilling a religious duty.',
	},
	{
		id: 2,
		name: 'Islamic Studies',
		description:
			'Courses on Islamic studies cover a wide range of topics, including Quranic studies, Hadith, Islamic jurisprudence (Fiqh), and theology (Aqidah).',
	},
	{
		id: 3,
		name: 'Islamic Ethics and Morality',
		description:
			'Courses on Islamic ethics and morality teach the principles of honesty, kindness, justice, and compassion, guiding students to live a righteous life.',
	},
	{
		id: 4,
		name: 'Arabic Language',
		description:
			'Learning Arabic is essential for understanding the Quran and Hadith. Courses in Arabic language help students access Islamic texts in their original form.',
	},
	{
		id: 5,
		name: 'Tafsir (Quranic Exegesis)',
		description:
			'Tafsir courses delve into the interpretation and commentary of the Quranic verses, providing deeper insights into the Quranic text.',
	},
	{
		id: 6,
		name: 'Hadith Sciences',
		description:
			'Courses on Hadith sciences teach the methodology of authenticating and understanding the sayings and actions of the Prophet Muhammad.',
	},
	{
		id: 7,
		name: 'Fiqh (Islamic Jurisprudence)',
		description:
			'Fiqh courses guide students in understanding Islamic laws and how they apply to various aspects of life, including worship, ethics, and transactions.',
	},
	{
		id: 8,
		name: 'Islamic History and Civilization',
		description:
			'Courses on Islamic history explore the rich heritage of Muslim civilizations, including the contributions of Muslim scholars, scientists, and philosophers.',
	},
	{
		id: 9,
		name: 'Online Learning',
		description:
			'With advancements in technology, online courses have become a convenient way to access Islamic education from anywhere in the world.',
	},
	{
		id: 10,
		name: 'Continual Learning',
		description:
			'Islamic education is a lifelong journey. Taking multiple courses ensures ongoing spiritual and intellectual growth in the faith.',
	},
];
...
export const tasbeeh = [
	{
		...
		description:
			'Tasbeeh, the act of glorifying and remembering Allah through repetitive phrases, holds a special virtue in Islam. It serves as a means of drawing closer to Allah, seeking His forgiveness, and finding tranquility in remembrance.',
	},
	{
		id: 2,
		name: 'SubhanAllah (Glory be to Allah)',
		description:
			'Reciting "SubhanAllah" signifies acknowledging Allah\'s perfection and transcendence over all imperfections. It is a common form of Tasbeeh.',
	},
	{
		id: 3,
		name: 'Alhamdulillah (Praise be to Allah)',
		description:
			'"Alhamdulillah" expresses gratitude and praise to Allah. It is another important phrase in the practice of Tasbeeh.',
	},
	{
		id: 4,
		name: 'Allahu Akbar (Allah is the Greatest)',
		description:
			'"Allahu Akbar" affirms Allah\'s greatness and supremacy. It is recited during various acts of worship and is a powerful form of Tasbeeh.',
	},
	{
		id: 5,
		name: 'Astaghfirullah (I seek forgiveness from Allah)',
		description:
			'Reciting "Astaghfirullah" is an act of seeking forgiveness and repentance. It reminds us of our human imperfections and Allah\'s mercy and forgiveness.',
	},
	{
		id: 6,
		name: 'Tasbeeh Beads (Misbahah)',
		description:
			'Tasbeeh beads (Misbahah) are a practical tool for counting repetitions while engaging in Tasbeeh. Each bead represents a phrase, facilitating focused remembrance of Allah.',
	},
];
...
export const quranReflections = [
	{
		...
		description:
			'Reflect on the Quran as a source of divine guidance without contradictions. [Quran 4:82]',
	},
	{
		name: 'Guidance and Good Tidings',
		description:
			'The Quran is a guide to what is suitable and brings good news to believers who do righteous deeds. [Quran 17:9]',
	},
	{
		name: 'Understanding the Quran',
		description:
			'The Quran was revealed in Arabic for understanding, emphasizing the importance of comprehension. [Quran 12:2]',
	},
	{
		name: 'Ease of Remembering',
		description:
			'Allah has made the Quran easy to remember, and we are encouraged to be mindful of it. [Quran 54:17]',
	},
	{
		name: 'Active Engagement',
		description:
			'When reminded of the verses of the Lord, we should not be deaf and blind but actively engage and reflect. [Quran 25:73]',
	},
];
...
export const IslamicKnowledgeAreas = [
	{
		...
		name: 'The Quran',
		description:
			'Reading, reciting, and understanding the Quran, the holy book of Islam.',
	},
	{
		id: 2,
		name: 'Hadith',
		description:
			'Studying the recorded sayings, actions, and approvals of the Prophet Muhammad.',
	},
	{
		id: 3,
		name: 'Aqidah (Theology)',
		description:
			'Understanding the core beliefs of Islam, including the oneness of God and the Day of Judgment.',
	},
	{
		id: 4,
		name: 'Fiqh (Islamic Jurisprudence)',
		description:
			'Learning Islamic laws and how they apply to various aspects of life.',
	},
	{
		id: 5,
		name: 'Salat (Prayer)',
		description:
			'Mastering the five daily prayers, including recitations and postures.',
	},
	{
		id: 10,
		name: 'Tazkiyah (Purification of the Soul)',
		description:
			'Pursuing self-purification, moral development, and spiritual growth.',
	},
	{
		id: 11,
		name: 'Islamic Ethics and Morality',
		description:
			'Learning Islamic values, ethics, and moral principles.',
	},
	{
		id: 12,
		name: 'Islamic Art and Culture',
		description:
			'Studying Islamic art, architecture, and cultural heritage influenced by Islamic principles.',
	},
	{
		id: 13,
		name: 'Arabic Language',
		description:
			'Mastering the Arabic language to understand Quranic text and Islamic literature.',
	},
];
...
export const starters = [
	{
		...
		name: 'Wudu (Ablution)',
		description:
			'Learning the steps and significance of ritual purification before prayers.',
	},
	{
		id: 2,
		name: 'Ghusl (Full Bath)',
		description:
			'Understanding when and how to perform a full bath for purification.',
	},
	{
		id: 3,
		name: 'Halal and Haram',
		description:
			'Recognizing permissible (halal) and prohibited (haram) aspects of food, drink, and daily life.',
	},
	{
		id: 4,
		name: 'Dress Code (Hijab)',
		description:
			'Exploring the principles of modesty in clothing and the concept of hijab (for women).',
	},
	{
		id: 5,
		name: 'Islamic Diet and Nutrition',
		description:
			'Learning about Islamic dietary guidelines, including avoiding pork and alcohol.',
	},
	{
		id: 6,
		name: 'Prayer Timings and Qibla',
		description:
			'Understanding how to determine prayer times and face the Qibla (direction of Mecca).',
	},
	{
		id: 7,
		name: 'Islamic Calendar',
		description:
			'Familiarizing oneself with the Islamic lunar calendar and its important dates.',
	},
	{
		id: 8,
		name: 'Basic Arabic Phrases',
		description:
			'Learning common Arabic phrases for prayer and daily interactions.',
	},
	{
		id: 9,
		name: 'Introduction to Islamic History',
		description:
			'Exploring the history and life of Prophet Muhammad and early Islamic civilization.',
	},
	{
		id: 10,
		name: 'Personal Hygiene and Cleanliness',
		description:
			'Maintaining proper hygiene practices in accordance with Islamic teachings.',
	},
];
...
export const kidsActivities = [
	{
		...
		description:
			'Engage kids with stories from Islamic history and Prophets.',
		ageRange: 'All Ages',
	},
	{
		id: 2,
		...
		description:
			'Teach kids to recite and understand Quranic verses.',
		ageRange: '3+ years',
	},
	{
		id: 3,
		...
		description:
			'Encourage creativity through Islamic-themed art and crafts.',
		ageRange: '4+ years',
	},
	{
		id: 4,
		...
		description:
			'Introduce kids to the Arabic language and alphabet.',
		ageRange: '5+ years',
	},
	{
		id: 5,
		...
		description:
			'Educational games and puzzles with Islamic themes.',
		ageRange: '6+ years',
	},
	{
		id: 6,
		...
		description:
			'Coloring books featuring Islamic motifs and characters.',
		ageRange: '3+ years',
	},
	{
		id: 7,
		...
		description:
			'Listen to and sing along with Islamic songs for kids.',
		ageRange: 'All Ages',
	},
	{
		id: 8,
		...
		description:
			'Teach kids Islamic manners and etiquette.',
		ageRange: '4+ years',
	},
	{
		id: 9,
		...
		description:
			'Dress-up activities with Islamic clothing and accessories.',
		ageRange: '3+ years',
	},
	{
		id: 10,
		...
		description:
			'Explore science and nature from an Islamic perspective.',
		ageRange: '6+ years',
	},
];
...
export const lessons = [
	...
	},
	{
		...
		name: 'Salah (Prayer)',
		description:
			'Daily prayers to connect with Allah.',
	...
	},
	{
		...
		name: 'Zakat (Charity)',
		description:
			'Giving to those in need as Ibadah.',
		duration: 'Yearly',
	},
	{
		id: 4,
		name: 'Sawm (Fasting)',
		description:
			'Fasting during Ramadan for self-purification.',
	...
	},
	{
		...
		description:
			'Pilgrimage to Mecca as an obligation.',
		duration:
	...
	},
	{
		...
		description:
			'Promote justice and fairness in all dealings.',
		duration: 'Ongoing',
	},
	{
		id: 8,
		...
		description:
			'Adhere to honesty and truthfulness in all aspects.',
		duration: 'Ongoing',
	},
	{
		id: 9,
		...
		description:
			'Value knowledge and pursue education.',
		duration: 'Ongoing',
	},
];
...
export const morningRoutines = [
	...
	},
	{
		...
		description:
			'Contemplate on your spirituality.',
		content: [],
		image: 'https://starsinsymmetry.files.wordpress.com/2013/12/image-php.jpg',
		duration: '15 minutes',
	},
	{
		...
		name: 'Quranic Study',
		description:
			'Study and reflect on the Quran.',
		content: [],
		image: 'https://starsinsymmetry.files.wordpress.com/2013/12/image-php.jpg',
		duration: '15 minutes',
	},
	{
		...
		description:
			'As muslims we ask Allah for aid.',
		content: [],
...
export const nightRoutines = [
	...
	},
	{
		...
		description:
			'Engage in heartfelt supplications.',
		image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Qur%27an_and_Rehal.jpg/640px-Qur%27an_and_Rehal.jpg',
		duration: '20 minutes',
	},
	{
		...
		description:
			'Study Islamic texts (e.g., Hadith or Tafsir).',
		content: [],
		image: 'https://media.licdn.com/dms/image/C5112AQHPcxj4kh9AmA/article-cover_image-shrink_600_2000/0/1520089674924?e=2147483647&v=beta&t=GWINL3JNehtf0Pf90JUscoV7A8CmF0aCFSdDhvSBMW8',
		duration: '30 minutes',
	},
	{
		...
		description:
			'Perform voluntary night prayer.',
		content: [],
		image: 'https://www.azernews.az/media/2023/07/07/1174386645.jpg',
		duration: '10-15 minutes',
	},
	{
		...
		description:
			'Reflect, express gratitude, and repent.',
		content: [],
		image: 'https://m2w4k5m5.stackpathcdn.com/wp-content/uploads/sonni-ali-1.jpg',
		duration: '15 minutes',
	},
	...
	},
	{
		...
		name: 'Tomorrows day',
		description:
			'Inshallah indeed the powerful is Allah.',
		content: [],
		image: 'https://starsinsymmetry.files.wordpress.com/2013/12/image-php.jpg',
		duration: '15 minutes',
	},
...
export const features = [
	{
		...
		description:
			'Reflect on a new Quranic verse every day.',
		image: 'https://yaqeeninstitute.org/wp-content/uploads/2018/10/Hadith_HeroImages.jpg',
	...
	},
	{
		...
		description:
			'Discover daily insights from Islamic wisdom and teachings.',
		image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Qur%27an_and_Rehal.jpg/640px-Qur%27an_and_Rehal.jpg',
	...
	},
	{
		...
		description:
			'Learn about the inspiring lives of the Prophet’s companions.',
		content: [],
		image: 'https://media.licdn.com/dms/image/C5112AQHPcxj4kh9AmA/article-cover_image-shrink_600_2000/0/1520089674924?e=2147483647&v=beta&t=GWINL3JNehtf0Pf90JUscoV7A8CmF0aCFSdDhvSBMW8',
	...
	},
	{
		...
		description:
			'Listen to beautiful Quranic recitations daily.',
		content: [],
		image: 'https://www.azernews.az/media/2023/07/07/1174386645.jpg',
	...
	},
	{
		...
		description:
			'Embark on a journey to explore the rich history of Islam.',
		content: [],
		image: 'https://m2w4k5m5.stackpathcdn.com/wp-content/uploads/sonni-ali-1.jpg',
	...
	},
	{
		...
		description:
			'Admire and learn about the beauty of Islamic art and calligraphy.',
		content: [],
		image: 'https://starsinsymmetry.files.wordpress.com/2013/12/image-php.jpg',
...
export const categories = [
	{
		...
		name: 'Daily Hadith',
		description:
			'Explore a new Hadith every day.',
		image: 'https://yaqeeninstitute.org/wp-content/uploads/2018/10/Hadith_HeroImages.jpg',
	},
	{
		id: 2,
		...
		description:
			'Discover the teachings of the Quran daily.',
		image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Qur%27an_and_Rehal.jpg/640px-Qur%27an_and_Rehal.jpg',
	},
	{
		id: 3,
		name: "Companions' Stories",
		description:
			'Learn about the lives of the companions.',
		content: [], // You can add specific content related to Prophet's companions here.
		image: 'https://media.licdn.com/dms/image/C5112AQHPcxj4kh9AmA/article-cover_image-shrink_600_2000/0/1520089674924?e=2147483647&v=beta&t=GWINL3JNehtf0Pf90JUscoV7A8CmF0aCFSdDhvSBMW8',
	},
	{
		id: 4,
		name: 'Quran Recitations',
		description:
			'Listen to beautiful Quranic recitations.',
		content: [], // You can add specific content related to Audio Quran here.
		image: 'https://www.azernews.az/media/2023/07/07/1174386645.jpg',
	},
	{
		id: 5,
		...
		description:
			'Explore the diverse history of Islam.',
		content: [], // You can add specific content related to Islamic History here.
	...
	},
	{
		...
		name: 'Islamic Art',
		description:
			'Admire Islamic art and calligraphy.',
		content: [], // You can add specific content related to Islamic Art and Calligraphy here.
...
export const challenges = [
	{
		...
		description:
			'Reflect on a new Quranic verse every day.',
		image: 'https://yaqeeninstitute.org/wp-content/uploads/2018/10/Hadith_HeroImages.jpg',
		daysLeft: 5, // Example value, replace with the actual number of days left.
	...
	},
	{
		...
		description:
			'Discover daily insights from Islamic wisdom and teachings.',
		image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/Qur%27an_and_Rehal.jpg/640px-Qur%27an_and_Rehal.jpg',
		daysLeft: 7, // Example value, replace with the actual number of days left.
	...
	},
	{
		...
		content: [], // You can add specific content related to Prophet's companions here.
		image: 'https://media.licdn.com/dms/image/C5112AQHPcxj4kh9AmA/article-cover_image-shrink_600_2000/0/1520089674924?e=2147483647&v=beta&t=GWINL3JNehtf0Pf90JUscoV7A8CmF0aCFSdDhvSBMW8',
		daysLeft: 10, // Example value, replace with the actual number of days left.
	...
	},
	{
		...
		content: [], // You can add specific content related to Audio Quran here.
		image: 'https://www.azernews.az/media/2023/07/07/1174386645.jpg',
		daysLeft: 3, // Example value, replace with the actual number of days left.
	...
	},
	{
		...
		content: [], // You can add specific content related to Islamic History here.
		image: 'https://m2w4k5m5.stackpathcdn.com/wp-content/uploads/sonni-ali-1.jpg', // Replace with the actual image URL for Islamic History.
		daysLeft: 15, // Example value, replace with the actual number of days left.
	...
	},
	{
		...
		content: [], // You can add specific content related to Islamic Art and Calligraphy here.
		image: 'https://starsinsymmetry.files.wordpress.com/2013/12/image-php.jpg', // Replace with the actual image URL for Islamic Art.
		daysLeft: 8, // Example value, replace with the actual number of days left.

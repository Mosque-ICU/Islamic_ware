  ...
  return (
    <>
      ...
      <div>
        ...
        <h1 className="mt-2 font-display text-4xl/tight font-light text-white">
          <span className="text-sky-300">Unparalleled authenticity.</span>
        </h1>
      </div>
      <p className="mt-4 text-sm/6 text-gray-300">
        An innovative Hadith platform, dedicated to delivering the essence of
        Hadith teachings with utmost clarity and reverence.
      </p>
      <SignUpForm />
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-200">
      An Initiative by{' '}

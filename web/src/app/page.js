            ...
            <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
              <figure className="relative isolate pt-6 sm:pt-12">
                ...
                <figcaption className="mt-8 text-base">
                  <div className="font-semibold text-white">placeholder</div>
                  <div className="mt-1 text-gray-400">CEO of nothing</div>
                </figcaption>
              </figure>
            </div>
          </div>
...
const footerNavigation = {
  solutions: [
    { name: "XDisplay", href: "#" },
    { name: "QuikBuilder", href: "#" },
    // { name: "Commerce", href: "#" },
    // { name: "Insights", href: "#" },
  ],
  support: [
    { name: "Pricing", href: "#pricing" },
    { name: "Documentation", href: "https://documentation.mosque.icu" },
    { name: "Guides", href: "#" },
    {
      name: "API Status",
  ...
  legal: [
    { name: "Claim", href: "/policy/claims" },
    { name: "Privacy", href: "/policy/privacy" },
    { name: "Terms", href: "/policy/terms" },
  ],
  social: [
    {
      name: "Facebook",
